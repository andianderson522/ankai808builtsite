...
public class SignGuestbookServletTest {
  ...
  public void testDoPost() throws IOException, EntityNotFoundException {
    ...
    String anaki808siteName = "TestGuestbook";
    String testContent = "Test Content";

    when(request.getParameter("anaki808siteName")).thenReturn(anaki808siteName);
    ...
    assertEquals(anaki808siteName, greeting.getKey().getParent().getName());
